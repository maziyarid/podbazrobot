        ...
        <form id="pbr-settings-form">
            ...
            <div class="pbr-settings-section">
                ...
                <div class="pbr-form-row">
                    ...
                    <select id="claude_model" name="claude_model">
                        ...
                        <optgroup label="🤝 عامل‌های پس‌زمینه (رایگان)">
                    ...
                    <span class="pbr-help">
                        مدل‌های رایگان برای شروع پیشنهاد می‌شوند
                    </span>
                </div>
                
                <div class="pbr-form-row">
                    <label>
                        <input type="checkbox" name="enable_multi_agent" value="yes" 
                               <?php checked($settings['enable_multi_agent'], 'yes'); ?>>
                        فعالسازی سیستم چند-عامله (Multi-Agent Orchestration)
                    </label>
                    <span class="pbr-help">
                        با فعالسازی این گزینه، سیستم از چندین عامل هوش مصنوعی برای بهبود کیفیت استفاده می‌کند
                    </span>
                </div>
            </div>
            ...
            <div class="pbr-settings-section">
                ...
                <div class="pbr-form-row">
                    ...
                    <span class="pbr-help">
                        رنگ اصلی در محتوای تولید شده استفاده خواهد شد
                    </span>
                </div>
                
                <div class="pbr-form-row">
                    <label>
                        <input type="checkbox" name="use_theme_color" value="yes" 
                               <?php checked($settings['use_theme_color'], 'yes'); ?>>
                        استفاده خودکار از رنگ اصلی قالب
                    </label>
                    <span class="pbr-help">
                        در صورت فعال بودن، رنگ اصلی از تنظیمات قالب فعال دریافت می‌شود
                    </span>
                </div>
            </div>
